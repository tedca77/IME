...
import IME.ConfigObject;
import static IME.IMEMethods.setDefaults;
...
import static IME.openmaps.OpenMaps.reverseGeocode;
...
class OpenMapsTest {
    ...
    void reverseGeocodeTest() {
        ...
        Place p =reverseGeocode("22.4","114.0", config);
