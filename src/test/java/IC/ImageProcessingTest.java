...
class ImageProcessingTest {
    @Test
    void createThumbFromPicture()
    {
        File file = new File("IPTC-PhotometadataRef-Std2021.1.jpg");
        String thumbName="THUMBIPTC-PhotometadataRef-Std2021.1.jpg";
       // createThumbFromPicture(File file,String tempDir,thumbName,200,120, 0);
    }
